...
export default function CheckoutTop() {
  ...
  return (
    <>
      <div className="flex justify-start items-center flex-row gap-[10px] sm:gap-[20px] lg:gap-[28px] mt-[70px] sm:mt-[95px] lg:mt-[104px] px-[22px] sm:px-[40px] lg:px-[90px] xl:px-[110px]">
        <button onClick={() => router.back()} className="cursor-pointer">
          <LuArrowLeft className="text-[#292d32ed] w-[19px] sm:w-[22px] h-[19px] sm:h-[22px]" />
        </button>

        <div className="w-full lg:w-[56%] xl:w-[59.3%] flex justify-between items-center gap-[12px] border-2">
