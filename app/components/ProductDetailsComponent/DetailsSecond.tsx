      ...
      <div className="sm:min-h-[400px] xl:min-h-[470px] flex justify-stretch items-center flex-col md:flex-row gap-[5px] sm:gap-[25px] lg:gap-[28px] mt-[20px] mb-[25px] sm:mt-[30px] sm:mb-[40px] lg:mt-[50px] lg:mb-[60px] px-[22px] sm:px-[40px] lg:px-[90px] xl:px-[90px]">
        ...
        <div className="w-full md:w-[48%] sm:min-h-[400px] xl:min-h-[450px] flex flex-col gap-[10px] md:gap-[10px] lg:gap-[18px] pt-2 sm:pt-1">
          ...
          <div className="relative flex justify-between items-center gap-[8px] sm:gap-[16px] mt-2 sm:mt-1">
            <div className="relative w-[50%]">
              <button
                ...
                className="w-full py-[5px] sm:py-[6px] lg:py-[9px] border border-[#202020e3] flex justify-center items-center gap-[8px] text-[#202020] text-[14px] lg:text-[17px] leading-[25px] font-ProximaNovaRegular font-light relative overflow-hidden group bg-transparent transition-all duration-300 ease-in-out hover:shadow-[0_3px_15px_rgba(32,32,32,0.15)]"
              >
                <span className="absolute inset-0 bg-[#202020] translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out"></span>
              ...
              {showNotification && (
                <div className="absolute top-full left-0 mt-2 bg-[#f5efe1] text-[#4a4a4a] p-3 shadow-lg z-50 animate-slideDown flex justify-between items-center  gap-3">
            ...
            <button
              ...
              className="w-[50%] py-[5px] sm:py-[6px] lg:py-[9px] bg-[#202020] flex justify-center items-center text-white text-[14px] lg:text-[17px] leading-[25px] font-ProximaNovaRegular font-light relative overflow-hidden group transition-all duration-300 ease-in-out hover:shadow-[0_3px_15px_rgba(32,32,32,0.15)]"
            >
              ...
              <span className="relative z-10 group-hover:text-[#202020] transition-colors duration-300">
                Buy now
              </span>
            </button>
          </div>
          ...
          <div
            ...
            className="w-fit flex items-center gap-2 sm:gap-3 mt-2 sm:mt-0 text-[#4e5075b0] hover:text-[#202020] transition-colors duration-300 relative group cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
          >
            <FaWhatsapp className="w-[19px] h-[19px] sm:w-[21px] sm:h-[21px] text-[#5AAA61]" />
            <p className="text-[#319639] text-[14px] lg:text-[16px] font-ProximaNovaRegular font-medium -mb-0.5">
