  ...
  return (
    <div className="flex flex-col md:flex-row gap-[30px] sm:gap-[20px] lg:gap-[37px]">
      ...
      <div className="w-full md:w-2/4 flex gap-[10px] sm:gap-[13px] flex-col">
        <h1 className="text-[#FFF] text-[16px] lg:text-[20px] leading-5 lg:leading-[20px] font-ProximaNovaRegular font-medium">
          About {getProductType(product.name)}
        </h1>
        <p className="text-[#ffffffb7] text-[14px] lg:text-[17px] leading-[30.6px] font-ProximaNovaRegular font-light">
          {product.longDescription.about}
        </p>
        <div className="flex flex-col gap-[6px]">
          <h2 className="text-[#FFF] text-[15px] lg:text-[19px] leading-5 lg:leading-[30px] font-ProximaNovaRegular font-medium">
            Key Features:
          </h2>
          <ol className="list-decimal list-inside text-[#ffffffb7] text-[14px] lg:text-[16px] leading-[30.6px] font-ProximaNovaRegular font-light pl-[10px]">
