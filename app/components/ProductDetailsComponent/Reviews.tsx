  ...
  return (
    <div className="flex flex-col md:flex-row gap-[35px] sm:gap-[20px] lg:gap-[37px]">
      <div className="w-full md:w-2/4 h-[240px] sm:h-[300px] lg:h-[420px] bg-[#FFFFFF1A] border-[#FFFFFF33] flex justify-center items-center flex-col gap-[15px]">
        ...
        <p className="text-[#ffffff] text-[16px] lg:text-[17px] font-ProximaNovaRegular font-light cursor-pointer">
      ...
      <div className="w-full md:w-2/4 sm:h-[300px] lg:h-[420px] flex gap-[30px] flex-col pt-1 overflow-y-auto scrollbar-hide">
        <div className="flex justify-between items-center">
          <h1 className="text-[#FFF] text-[17px] lg:text-[20px] leading-5 lg:leading-[20px] font-ProximaNovaRegular font-medium cursor-pointer">
            All reviews
          </h1>
          <Link
            href="#"
              ...
              <div className="flex justify-between items-start w-full">
                <div className="flex justify-between items-start gap-[8px]">
                  ...
                  <div className="flex justify-start items-start flex-col gap-[6px] -mt-1">
                    <h1 className="text-[#FFFFFFCC] text-[16px] lg:text-[17px] leading-5 lg:leading-[27px] font-ProximaNovaRegular font-normal cursor-pointer">
                      {review.user}
                    </h1>
                    ...
                    <p className="text-[#ffffffb6] text-[16px] lg:text-[17px] font-ProximaNovaRegular font-normal cursor-pointer">
                      {review.comment}
                    </p>
                  </div>
                </div>
                <h1 className="text-[#ffffffb6] text-[16px] lg:text-[16px] leading-5 lg:leading-[21px] font-ProximaNovaRegular font-normal cursor-pointer">
                  {review.date}
                </h1>
              </div>
